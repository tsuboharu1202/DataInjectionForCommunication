...
switch method_str
    case {cfg.AttackType.DIRECT_DGSM_DELTA, "DIRECT_DGSM_DELTA"}
        [X_adv, Z_adv, U_adv] = algorithms.dgsm_delta(system_data, eps_att, direction, opts);
    ...
    case {cfg.AttackType.IMPLICIT_IDGSM_DELTA, "IMPLICIT_IDGSM_DELTA"}
        ...
        if save_history
            [X_adv, Z_adv, U_adv, history] = algorithms.idgsm_delta(system_data, save_history, [], [], eps_att, direction, save_grad_norms, opts);
        else
            [X_adv, Z_adv, U_adv] = algorithms.idgsm_delta(system_data, false, [], [], eps_att, direction, save_grad_norms, opts);
        end
    ...
    case {cfg.AttackType.IMPLICIT_IDGSM_DELTA_POSITIVE, "IMPLICIT_IDGSM_DELTA_POSITIVE"}
        ...
        if save_history
            [X_adv, Z_adv, U_adv, history] = algorithms.idgsm_delta(system_data, save_history, [], [], eps_att, 'positive', save_grad_norms, opts);
        else
            [X_adv, Z_adv, U_adv] = algorithms.idgsm_delta(system_data, false, [], [], eps_att, 'positive', save_grad_norms, opts);
        end
    ...
    case {cfg.AttackType.IMPLICIT_IDGSM_DELTA_NEGATIVE, "IMPLICIT_IDGSM_DELTA_NEGATIVE"}
        ...
        if save_history
            [X_adv, Z_adv, U_adv, history] = algorithms.idgsm_delta(system_data, save_history, [], [], eps_att, 'negative', save_grad_norms, opts);
        else
            [X_adv, Z_adv, U_adv] = algorithms.idgsm_delta(system_data, false, [], [], eps_att, 'negative', save_grad_norms, opts);
        end
