...
[gradX_delta, gradZ_delta, gradU_delta] = common.calc_grad(sd, opts);

% 攻撃データを生成
[X_adv, Z_adv, U_adv] = algorithms.make_data_adv(sd, gradX_delta, gradZ_delta, gradU_delta, eps_att, direction);
end
