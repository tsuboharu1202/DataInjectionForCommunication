...
for sys_idx = 1:n_systems
    ...
    try
        [sol_with_reg, ~, ~, ~, diagnostics_with_reg] = proposed.solve_sdp(data, gamma_with_reg);
    ...
    try
        [sol_without_reg, ~, ~, ~, diagnostics_without_reg] = proposed.solve_sdp(data, gamma_without_reg);
