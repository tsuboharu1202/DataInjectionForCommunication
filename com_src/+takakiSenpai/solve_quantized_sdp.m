% function [sol, K, Y, L, diagnostics] = solve_quantized_sdp(data, opts)
...
%     % LMI blocks (25)(26)(27)
%     % -------------------------
%     [M25, M26, M27] = build_lmi_blocks(Y, L, alpha, beta, tTau, tDelta, H, E1, E2, G, Phi);

%     % -------------------------
%     % Constraints
%     % -------------------------
%     if ~isfield(opts,'psd_slack'), opts.psd_slack = 1e-5; end
...
%     % Solve
%     % -------------------------
%     params        = sdpsettings('solver', opts.solver, 'verbose', 1, 'debug', 1);
