...
F1_base = implicit_regularization.helper.F1_of_D(n,m,T,B,L,delta,D);
vecF1_base = F1_base(:);

J = implicit_regularization.helper.dF_dD(n,m,T,L); % あなたの dF_dD
...
for trial = 1:nTrials
    ...
    for e = 1:numel(eps_list)
        ...
        F1_p = implicit_regularization.helper.F1_of_D(n,m,T,B,L,delta, D + eps*E);
