...
J = implicit_regularization.helper.dPi_dD(n,m,T,Gamma); % (T^2) x (T*(2n+m))

% base Pi
Pi0 = implicit_regularization.helper.Pi_of_D(n,m,T,D);
v0  = Pi0(:);
...
for k = 1:numel(eps_list)
    ...
    Pi1 = implicit_regularization.helper.Pi_of_D(n,m,T, D + eps*E);
    v1  = Pi1(:);
