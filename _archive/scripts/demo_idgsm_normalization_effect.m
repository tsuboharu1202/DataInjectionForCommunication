...
%         fprintf('  初期SDPを解く...\n');
%         try
%             [sol_init, ~, ~, ~, diagnostics_init] = regularization_sdp.solve_sdp(data, gamma);
...
%         try
%             [X_idgsm_norm, Z_idgsm_norm, U_idgsm_norm, history_norm] = attack.idgsm_delta(...
...
%             [sol_final_norm, ~, ~, ~, diagnostics_final_norm] = regularization_sdp.solve_sdp(data_final_norm, gamma);
...
%         try
%             [X_idgsm_no_norm, Z_idgsm_no_norm, U_idgsm_no_norm, history_no_norm] = attack.idgsm_delta(...
...
%             [sol_final_no_norm, ~, ~, ~, diagnostics_final_no_norm] = regularization_sdp.solve_sdp(data_final_no_norm, gamma);
